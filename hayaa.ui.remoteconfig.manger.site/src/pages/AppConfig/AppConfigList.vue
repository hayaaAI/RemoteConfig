<template>
  <div style="margin-left: 25px">
    <div style="float: right">
      <el-button type="primary" @click="add">添加</el-button><el-button type="primary" @click="back">返回</el-button>
    </div>
    <el-table :data="tableData">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          <el-button size="mini" @click="editComponet(scope.row.appConfigId,scope.row.version)">编辑组件</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      editComponet: function (appConfigId, version) {
        this.$router.push("/home/appcomponentlist/" + appConfigId + "/" + version);
      },
      add: function () {
