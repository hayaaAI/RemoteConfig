...
///代码效率工具生成，此文件不要修改
/// </summary>
namespace Hayaa.RemoteConfig.Service{public class AppSearchPamater:SearchPamaterMariadbBase {public int? AppId{set;get;}
...
private String GetAppIdSqlForSharp(){String sql = "";switch (AppIdPOT){
