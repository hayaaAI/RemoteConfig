...
///代码效率工具生成，此文件不要修改
/// </summary>
namespace Hayaa.RemoteConfig.Service{public class Rel_AppConfig_ComponentConfigSearchPamater:SearchPamaterMariadbBase {public int? Id{set;get;}
...
private String GetIdSqlForSharp(){String sql = "";switch (IdPOT){
...
private String GetAppConfigIdSqlForSharp(){String sql = "";switch (AppConfigIdPOT){
...
private String GetAppConfigVersionSqlForSharp(){String sql = "";switch (AppConfigVersionPOT){
...
private String GetSolutionIDSqlForSharp(){String sql = "";switch (SolutionIDPOT){
...
private String GetComponentConfigIdSqlForSharp(){String sql = "";switch (ComponentConfigIdPOT){
...
private String GetComponentConfigVersionSqlForSharp(){String sql = "";switch (ComponentConfigVersionPOT){
