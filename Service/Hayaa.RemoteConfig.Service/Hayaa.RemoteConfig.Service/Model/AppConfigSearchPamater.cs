...
///代码效率工具生成，此文件不要修改
/// </summary>
namespace Hayaa.RemoteConfig.Service{public class AppConfigSearchPamater:SearchPamaterMariadbBase {public int? AppConfigId{set;get;}
...
private String GetSolutionNameSqlForSharp(){String sql = "";switch (SolutionNamePOT){
...
private String GetConfigContentSqlForSharp(){String sql = "";switch (ConfigContentPOT){
